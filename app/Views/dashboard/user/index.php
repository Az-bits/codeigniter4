            ...
            <tr>
                ...
                <td>
                    <form action="/client/delete/<?= $u->id ?>" method="POST">
                        <button data-toggle="tooltip" data-placement="top" title="Borrar" class="float-right ml-2 btn btn-danger btn-sm" type="submit"><i class="fa fa-trash"></i></button>
                    </form>
...
<!-- links es para paginar (se puede acceder a ella con 'pager' => $uovie->pager)-->
<?= $pager->links() ?>